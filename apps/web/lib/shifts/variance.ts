// Variance severity thresholds (KES), shared by the close-shift dialog,
// shift summary sheet, and shift history list so they all agree on what
// counts as "fine" vs "needs a recount" vs "needs explaining".
