...
const CHAPTERS: Chapter[] = [
  {
    ...
    tip: { kind: "tip", text: "The 30-day trial unlocks every Growth-tier feature — M-Pesa STK push, prescriptions, multiple branches — regardless of which plan you end up billed on. (Appointments, reminders, and reports are included on every plan, even Starter.) Use the trial to actually try everything, not just the basics." },
    shots: [
